...
const ResetPassword = () => {
    ...
    return (
        <div>
            <Navbar />
                <section
                    className="flex-col h-screen bg-cover"
                    style={{
                    backgroundImage:
                        "url('https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&w=1950&q=80')",
                    }}
                >
                    <div className="flex flex-col items-center justify-center px-6 py-8 my-auto mx-auto md:h-screen lg:py-0 backdrop-blur-md">
